  ...
  return (
    <main className="bg-sky-500 sm:bg-sky-700 md:bg-sky-100 lg:bg-sky-300 xl:bg-sky-600 h-screen font-Montserrat">
      ...
      <div className="flex flex-col sm:flex-row w-full absolute top-0 left-0 h-auto sm:h-screen">
        <SideSection className="h-full group">
          ...
          <div className="group-hover:block group-hover:animate-fadeIn hidden absolute w-full h-full backdrop-blur-xl bg-black/70 ps-16 pt-[25%] italic ">
            {/* My Info */}
            <section className="">
